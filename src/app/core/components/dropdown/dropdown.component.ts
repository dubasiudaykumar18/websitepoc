...
export class DropdownComponent {
  ...
  // References of HTML
  @ViewChild("dropdownMenu", { static: false}) private dropdownMenu: ElementRef;
  @ViewChild("dropdownButton", { static: false}) private dropdownButton: ElementRef;
  @ViewChild("dropdownInput", { static: false}) private dropdownInput: ElementRef;
  @ViewChild("dropdownFilter", { static: false}) private dropdownFilter: ElementRef;
